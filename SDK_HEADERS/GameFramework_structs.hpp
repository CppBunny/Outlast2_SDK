...
struct FAgentArchetypeInfo
{
	...
	int32_t                                            MaxAllowed;                                    // 0x000C (0x0004) [0x0000000000000001] (CPF_Edit)    
	int32_t                                            CurrSpawned;                                   // 0x0010 (0x0004) [0x0000000000002000] (CPF_Transient)
...
struct FCrowdSpawnInfoItem
{
	...
	uint32_t                                           bSpawningActive : 1;                           // 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              SpawnRate;                                     // 0x000C (0x0004) [0x0000000000000000]               
	int32_t                                            SpawnNum;                                      // 0x0010 (0x0004) [0x0000000000000000]               
	...
	uint32_t                                           bForceObstacleChecking : 1;                    // 0x0050 (0x0004) [0x0000000000000000] [0x00000001] 
	uint32_t                                           bForceNavMeshPathing : 1;                      // 0x0050 (0x0004) [0x0000000000000000] [0x00000002] 
	uint32_t                                           bEnableCrowdLightEnvironment : 1;              // 0x0050 (0x0004) [0x0000000000000000] [0x00000004] 
	uint32_t                                           bCastShadows : 1;                              // 0x0050 (0x0004) [0x0000000000000000] [0x00000008] 
	struct FLightingChannelContainer                   AgentLightingChannel;                          // 0x0054 (0x0004) [0x0000000000000000]               
	int32_t                                            NumAgentsToTickPerFrame;                       // 0x0058 (0x0004) [0x0000000000000001] (CPF_Edit)    
	int32_t                                            LastAgentTickedIndex;                          // 0x005C (0x0004) [0x0000000000000000]               
	...
	int32_t                                            PrioritizationIndex;                           // 0x0074 (0x0004) [0x0000000000000000]               
	int32_t                                            PrioritizationUpdateIndex;                     // 0x0078 (0x0004) [0x0000000000000000]               
...
struct FAICmdHistoryItem
{
	...
	class FString                                      VerboseString;                                 // 0x000C (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
struct FSpecialMoveStruct
{
	...
	int32_t                                            Flags;                                         // 0x0018 (0x0004) [0x0000000000000000]               
};
...
struct FTakeHitInfo
{
	...
	uint8_t                                            HitBoneIndex;                                  // 0x0028 (0x0001) [0x0000000000000000]               
...
struct FScreenShakeAnimStruct
{
	...
	uint32_t                                           bUseDirectionalAnimVariants : 1;               // 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
	...
	uint32_t                                           bRandomSegment : 1;                            // 0x0034 (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              RandomSegmentDuration;                         // 0x0038 (0x0004) [0x0000000000000000]               
	uint32_t                                           bSingleInstance : 1;                           // 0x003C (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FBehaviorEntry
{
	...
	uint32_t                                           bNeverRepeat : 1;                              // 0x0014 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
	uint32_t                                           bHasBeenUsed : 1;                              // 0x0014 (0x0004) [0x0000000000000000] [0x00000002] 
	uint32_t                                           bCanBeUsed : 1;                                // 0x0014 (0x0004) [0x0000000000000000] [0x00000004] 
};
...
{
	class FString                                      GroupName;                                     // 0x0000 (0x0010) [0x0000000000404000] (CPF_Config | CPF_NeedCtorLink)
	TArray<class FString>                              RequireZoneNames;                              // 0x0010 (0x0010) [0x0000000000504000] (CPF_Config | CPF_NeedCtorLink)
	uint32_t                                           bIsAttractModeGroup : 1;                       // 0x0020 (0x0004) [0x0000000000004000] [0x00000001] (CPF_Config)
};
...
struct FTeamState
{
	...
	TArray<int32_t>                                    PlayerIndices;                                 // 0x0004 (0x0010) [0x0000000000500000] (CPF_NeedCtorLink)
};
...
struct FCamFocusPointParams
{
	...
	uint32_t                                           bAlwaysFocus : 1;                              // 0x0030 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
	uint32_t                                           bAdjustCamera : 1;                             // 0x0030 (0x0004) [0x0000000000000001] [0x00000002] (CPF_Edit)
	uint32_t                                           bIgnoreTrace : 1;                              // 0x0030 (0x0004) [0x0000000000000001] [0x00000004] (CPF_Edit)
...
struct FTouchData
{
	...
	uint8_t                                            State;                                         // 0x0038 (0x0001) [0x0000000000000000]               
...
struct FMenuListDragInfo
{
	...
	int32_t                                            NumUpdates;                                    // 0x004C (0x0004) [0x0000000000000000]               
	uint32_t                                           bHasSelectedChanged : 1;                       // 0x0050 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FPropertyInfo
{
	...
	class FString                                      PropertyValue;                                 // 0x000C (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
};
