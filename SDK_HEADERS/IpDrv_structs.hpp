...
struct FMcpClashMobChallengeFile
{
	...
	class FString                                      title_id;                                      // 0x0004 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class FString                                      file_name;                                     // 0x0014 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class FString                                      dl_name;                                       // 0x0024 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class FString                                      hash_code;                                     // 0x0034 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class FString                                      Type;                                          // 0x0044 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	uint8_t                                            Status;                                        // 0x0054 (0x0001) [0x0000000000000000]               
};
...
struct FMcpClashMobChallengeEvent
{
	...
	class FString                                      twitter_id;                                    // 0x00CC (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
struct FMcpClashMobChallengeUserStatus
{
	...
	class FString                                      accept_time;                                   // 0x0044 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	uint32_t                                           did_preregister : 1;                           // 0x0054 (0x0004) [0x0000000000000000] [0x00000001] 
	class FString                                      facebook_like_time;                            // 0x0058 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	uint32_t                                           enrolled_via_facebook : 1;                     // 0x0068 (0x0004) [0x0000000000000000] [0x00000001] 
	uint32_t                                           liked_via_facebook : 1;                        // 0x0068 (0x0004) [0x0000000000000000] [0x00000002] 
	uint32_t                                           commented_via_facebook : 1;                    // 0x0068 (0x0004) [0x0000000000000000] [0x00000004] 
	class FString                                      twitter_retweet_time;                          // 0x006C (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	uint32_t                                           enrolled_via_twitter : 1;                      // 0x007C (0x0004) [0x0000000000000000] [0x00000001] 
	uint32_t                                           retweeted : 1;                                 // 0x007C (0x0004) [0x0000000000000000] [0x00000002] 
};
...
struct FTitleFileWeb : FTitleFile
{
	...
	uint8_t                                            FileCompressionType;                           // 0x003C (0x0001) [0x0000000000000000]               
};
...
struct FMcpInventoryItem
{
	...
	class FString                                      LastUpdateTime;                                // 0x002C (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
struct FClientConnectionRequest
{
	...
	uint32_t                                           bCanHostVs : 1;                                // 0x0014 (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              GoodHostRatio;                                 // 0x0018 (0x0004) [0x0000000000000000]               
	TArray<struct FConnectionBandwidthStats>           BandwidthHistory;                              // 0x001C (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	int32_t                                            MinutesSinceLastTest;                          // 0x002C (0x0004) [0x0000000000000000]               
};
...
struct FClientMeshBeaconConnection
{
	...
	struct FPointer                                    Socket;                                        // 0x0014 (0x0008) [0x0000000000003000] (CPF_Native | CPF_Transient)
	uint32_t                                           bConnectionAccepted : 1;                       // 0x001C (0x0004) [0x0000000000000000] [0x00000001] 
	struct FClientConnectionBandwidthTestData          BandwidthTest;                                 // 0x0020 (0x0028) [0x0000000000000000]               
	...
	TArray<struct FConnectionBandwidthStats>           BandwidthHistory;                              // 0x0054 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	int32_t                                            MinutesSinceLastTest;                          // 0x0064 (0x0004) [0x0000000000000000]               
};
...
struct FEventUploadConfig
{
	...
	uint32_t                                           bUseCompression : 1;                           // 0x0018 (0x0004) [0x0000000000000002] [0x00000001] (CPF_Const)
};
...
struct FNewsCacheEntry
{
	...
	uint32_t                                           bIsUnicode : 1;                                // 0x0028 (0x0004) [0x0000000000000002] [0x00000001] (CPF_Const)
...
struct FPlaylist
{
	...
	uint32_t                                           bDisableDedicatedServerSearches : 1;           // 0x0068 (0x0004) [0x0000000000000000] [0x00000001] 
...
{
	struct FUniqueNetId                                NetId;                                         // 0x0000 (0x0010) [0x0000000000000000]               
	int32_t                                            Skill;                                         // 0x0010 (0x0004) [0x0000000000000000]               
	int32_t                                            XpLevel;                                       // 0x0014 (0x0004) [0x0000000000000000]               
	struct FDouble                                     Mu;                                            // 0x0018 (0x0008) [0x0000000000000000]               
	struct FDouble                                     Sigma;                                         // 0x0020 (0x0008) [0x0000000000000000]               
	float                                              ElapsedSessionTime;                            // 0x0028 (0x0004) [0x0000000000000000]               
};
...
{
	int32_t                                            TeamNum;                                       // 0x0000 (0x0004) [0x0000000000000000]               
	struct FUniqueNetId                                PartyLeader;                                   // 0x0004 (0x0010) [0x0000000000000000]               
	TArray<struct FPlayerReservation>                  PartyMembers;                                  // 0x0014 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
