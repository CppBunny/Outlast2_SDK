...
struct UFacebookWindows_execOnFacebookFriendsRequestComplete_Params
{
	...
	// class FString                                      JsonPayload;                                      		// 0x0014 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	...
	// struct FPlatformInterfaceDelegateResult            DelegateResult;                                   		// 0x0038 (0x0040) [0x0000000000400000] (CPF_NeedCtorLink)
	// struct FFacebookFriend                             Friend;                                           		// 0x0078 (0x0020) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
struct UFacebookWindows_execOnFacebookMeRequestComplete_Params
{
	...
	// class FString                                      JsonPayload;                                      		// 0x0014 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	// class UJsonObject*                                 ParsedJson;                                       		// 0x0024 (0x0008) [0x0000000000000000]               
	// struct FPlatformInterfaceDelegateResult            DelegateResult;                                   		// 0x002C (0x0040) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
{
	uint32_t                                           ReturnValue : 1;                                  		// 0x0000 (0x0004) [0x0000000000000580] [0x00000001] (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
	// class FString                                      URL;                                              		// 0x0004 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
