...
void AGameAIController::SetDesiredRotation(struct FRotator TargetDesiredRotation, bool InLockDesiredRotation, bool InUnlockWhenReached, float InterpolationTime)
{
...
void AGameAIController::eventAILog_Internal(class FString LogText, struct FName LogCategory, bool bForce)
{
...
class UGameAICommand* AGameAIController::GetAICommandInStack(class UClass* InClass)
{
	...
	memcpy_s(&GetAICommandInStack_Params.InClass, sizeof(GetAICommandInStack_Params.InClass), &InClass, sizeof(InClass));
...
class UGameAICommand* AGameAIController::FindCommandOfClass(class UClass* SearchClass)
{
	...
	memcpy_s(&FindCommandOfClass_Params.SearchClass, sizeof(FindCommandOfClass_Params.SearchClass), &SearchClass, sizeof(SearchClass));
...
bool AGameAIController::AbortCommand(class UGameAICommand* AbortCmd, class UClass* AbortClass)
{
	...
	memcpy_s(&AbortCommand_Params.AbortCmd, sizeof(AbortCommand_Params.AbortCmd), &AbortCmd, sizeof(AbortCmd));
	memcpy_s(&AbortCommand_Params.AbortClass, sizeof(AbortCommand_Params.AbortClass), &AbortClass, sizeof(AbortClass));
...
void AGameAIController::PopCommand(class UGameAICommand* ToBePoppedCommand)
{
	...
	memcpy_s(&PopCommand_Params.ToBePoppedCommand, sizeof(PopCommand_Params.ToBePoppedCommand), &ToBePoppedCommand, sizeof(ToBePoppedCommand));
...
void AGameAIController::PushCommand(class UGameAICommand* NewCommand)
{
	...
	memcpy_s(&PushCommand_Params.NewCommand, sizeof(PushCommand_Params.NewCommand), &NewCommand, sizeof(NewCommand));
...
void AGameAIController::AllCommands(class UClass* BaseClass, class UGameAICommand*& Cmd)
{
	...
	memcpy_s(&AllCommands_Params.BaseClass, sizeof(AllCommands_Params.BaseClass), &BaseClass, sizeof(BaseClass));
	memcpy_s(&AllCommands_Params.Cmd, sizeof(AllCommands_Params.Cmd), &Cmd, sizeof(Cmd));

	uFnAllCommands->FunctionFlags &= ~0x400;
	this->ProcessEvent(uFnAllCommands, &AllCommands_Params, nullptr);
	uFnAllCommands->FunctionFlags |= 0x400;

	memcpy_s(&Cmd, sizeof(Cmd), &AllCommands_Params.Cmd, sizeof(AllCommands_Params.Cmd));
};
...
void AGameAIController::TestLogAIToConsole(int32_t Verbosity)
{
	static UFunction* uFnTestLogAIToConsole = nullptr;

	if (!uFnTestLogAIToConsole)
	{
		uFnTestLogAIToConsole = UFunction::FindFunction("Function GameFramework.GameAIController.TestLogAIToConsole");
	}

	AGameAIController_execTestLogAIToConsole_Params TestLogAIToConsole_Params;
...
bool UGameAICommand::HandlePathObstruction(class AActor* BlockedBy)
{
	...
	memcpy_s(&HandlePathObstruction_Params.BlockedBy, sizeof(HandlePathObstruction_Params.BlockedBy), &BlockedBy, sizeof(BlockedBy));
...
bool UGameAICommand::MoveUnreachable(struct FVector AttemptedDest, class AActor* AttemptedTarget)
{
	...
	memcpy_s(&MoveUnreachable_Params.AttemptedTarget, sizeof(MoveUnreachable_Params.AttemptedTarget), &AttemptedTarget, sizeof(AttemptedTarget));
...
void UGameAICommand::GetDebugOverheadText(class APlayerController* PC, TArray<class FString>& OutText)
{
	...
	memcpy_s(&GetDebugOverheadText_Params.PC, sizeof(GetDebugOverheadText_Params.PC), &PC, sizeof(PC));
...
void UGameAICommand::eventDrawDebug(class AHUD* H, struct FName Category)
{
	...
	memcpy_s(&DrawDebug_Params.H, sizeof(DrawDebug_Params.H), &H, sizeof(H));
...
void UGameAICommand::Paused(class UGameAICommand* NewCommand)
{
	...
	memcpy_s(&Paused_Params.NewCommand, sizeof(Paused_Params.NewCommand), &NewCommand, sizeof(NewCommand));
...
void UGameAICommand::PrePushed(class AGameAIController* AI)
{
	...
	memcpy_s(&PrePushed_Params.AI, sizeof(PrePushed_Params.AI), &AI, sizeof(AI));
...
bool UGameAICommand::AllowTransitionTo(class UClass* AttemptCommand)
{
	...
	memcpy_s(&AllowTransitionTo_Params.AttemptCommand, sizeof(AllowTransitionTo_Params.AttemptCommand), &AttemptCommand, sizeof(AttemptCommand));
...
void UGameAICommand::eventInternalPaused(class UGameAICommand* NewCommand)
{
	...
	memcpy_s(&InternalPaused_Params.NewCommand, sizeof(InternalPaused_Params.NewCommand), &NewCommand, sizeof(NewCommand));
...
void UGameAICommand::eventInternalPrePushed(class AGameAIController* AI)
{
	...
	memcpy_s(&InternalPrePushed_Params.AI, sizeof(InternalPrePushed_Params.AI), &AI, sizeof(AI));
...
bool UGameAICommand::InitCommand(class AGameAIController* AI)
{
	...
	memcpy_s(&InitCommand_Params.AI, sizeof(InitCommand_Params.AI), &AI, sizeof(AI));
...
bool UGameAICommand::InitCommandUserActor(class AGameAIController* AI, class AActor* UserActor)
{
	...
	memcpy_s(&InitCommandUserActor_Params.AI, sizeof(InitCommandUserActor_Params.AI), &AI, sizeof(AI));
	memcpy_s(&InitCommandUserActor_Params.UserActor, sizeof(InitCommandUserActor_Params.UserActor), &UserActor, sizeof(UserActor));
...
// [0xFFFF0000010201C0] (FUNC_Net | FUNC_NetReliable | FUNC_Simulated | FUNC_Public | FUNC_NetClient | FUNC_NetValidate | FUNC_AllFlags)
// Parameter Info:
// struct FColor                  _FadeColor                     (CPF_Parm)
// uint8_t                        _FromAlpha                     (CPF_Parm)
// uint8_t                        _ToAlpha                       (CPF_Parm)
// float                          _FadeTime                      (CPF_Parm)

void AGamePlayerController::ClientColorFade(struct FColor _FadeColor, uint8_t _FromAlpha, uint8_t _ToAlpha, float _FadeTime)
{
	...
	memcpy_s(&ClientColorFade_Params._FadeColor, sizeof(ClientColorFade_Params._FadeColor), &_FadeColor, sizeof(_FadeColor));
	memcpy_s(&ClientColorFade_Params._FromAlpha, sizeof(ClientColorFade_Params._FromAlpha), &_FromAlpha, sizeof(_FromAlpha));
	memcpy_s(&ClientColorFade_Params._ToAlpha, sizeof(ClientColorFade_Params._ToAlpha), &_ToAlpha, sizeof(_ToAlpha));
	memcpy_s(&ClientColorFade_Params._FadeTime, sizeof(ClientColorFade_Params._FadeTime), &_FadeTime, sizeof(_FadeTime));
...
// [0xFFFF000001020DC1] (FUNC_Final | FUNC_Net | FUNC_NetReliable | FUNC_Simulated | FUNC_Native | FUNC_Event | FUNC_Public | FUNC_NetClient | FUNC_NetValidate | FUNC_AllFlags)
// Parameter Info:
...
void AGamePlayerController::eventClientPlayMovie(class FString MovieName, int32_t InStartOfRenderingMovieFrame, int32_t InEndOfRenderingMovieFrame, bool bRestrictPausing, bool bPlayOnceFromStream, bool bOnlyBackButtonSkipsMovie)
{
...
void AGamePlayerController::DoForceFeedbackForScreenShake(class UCameraShake* ShakeData, float Scale)
{
	...
	memcpy_s(&DoForceFeedbackForScreenShake_Params.ShakeData, sizeof(DoForceFeedbackForScreenShake_Params.ShakeData), &ShakeData, sizeof(ShakeData));
...
void AGamePlayerController::eventNotifyCrowdAgentInRadius(class AGameCrowdAgent* Agent)
{
	...
	memcpy_s(&NotifyCrowdAgentInRadius_Params.Agent, sizeof(NotifyCrowdAgentInRadius_Params.Agent), &Agent, sizeof(Agent));
...
void AGamePlayerController::OnToggleMouseCursor(class USeqAct_ToggleMouseCursor* inAction)
{
	...
	memcpy_s(&OnToggleMouseCursor_Params.inAction, sizeof(OnToggleMouseCursor_Params.inAction), &inAction, sizeof(inAction));
...
void UGameCheatManager::OnRequestComplete(class UHttpRequestInterface* OriginalRequest, class UHttpResponseInterface* Response, bool bDidSucceed)
{
	...
	memcpy_s(&OnRequestComplete_Params.OriginalRequest, sizeof(OnRequestComplete_Params.OriginalRequest), &OriginalRequest, sizeof(OriginalRequest));
	memcpy_s(&OnRequestComplete_Params.Response, sizeof(OnRequestComplete_Params.Response), &Response, sizeof(Response));
...
void UGameCheatManager::TestHttp(class FString Verb, class FString Payload, class FString URL, bool bSendParallelRequest)
{
...
void AGameCrowdAgent::eventOverlappedActorEvent(class AActor* A)
{
	...
	memcpy_s(&OverlappedActorEvent_Params.A, sizeof(OverlappedActorEvent_Params.A), &A, sizeof(A));
...
void AGameCrowdAgent::eventUpdateIntermediatePoint(class AActor* DestinationActor)
{
	...
	memcpy_s(&UpdateIntermediatePoint_Params.DestinationActor, sizeof(UpdateIntermediatePoint_Params.DestinationActor), &DestinationActor, sizeof(DestinationActor));
...
void AGameCrowdAgent::SetCurrentBehavior(class UGameCrowdAgentBehavior* BehaviorArchetype)
{
	...
	memcpy_s(&SetCurrentBehavior_Params.BehaviorArchetype, sizeof(SetCurrentBehavior_Params.BehaviorArchetype), &BehaviorArchetype, sizeof(BehaviorArchetype));
...
void AGameCrowdAgent::eventHandleBehaviorEvent(ECrowdBehaviorEvent EventType, class AActor* InInstigator, bool bViralCause, bool bPropagateViralFlag)
{
	...
	memcpy_s(&HandleBehaviorEvent_Params.InInstigator, sizeof(HandleBehaviorEvent_Params.InInstigator), &InInstigator, sizeof(InInstigator));
...
void AGameCrowdAgent::ActivateInstancedBehavior(class UGameCrowdAgentBehavior* NewBehaviorObject)
{
	...
	memcpy_s(&ActivateInstancedBehavior_Params.NewBehaviorObject, sizeof(ActivateInstancedBehavior_Params.NewBehaviorObject), &NewBehaviorObject, sizeof(NewBehaviorObject));
...
void AGameCrowdAgent::eventActivateBehavior(class UGameCrowdAgentBehavior* NewBehaviorArchetype, class AActor* LookAtActor)
{
	...
	memcpy_s(&ActivateBehavior_Params.NewBehaviorArchetype, sizeof(ActivateBehavior_Params.NewBehaviorArchetype), &NewBehaviorArchetype, sizeof(NewBehaviorArchetype));
	memcpy_s(&ActivateBehavior_Params.LookAtActor, sizeof(ActivateBehavior_Params.LookAtActor), &LookAtActor, sizeof(LookAtActor));
...
void AGameCrowdAgent::eventNotifySeePlayer(class APlayerController* PC)
{
	...
	memcpy_s(&NotifySeePlayer_Params.PC, sizeof(NotifySeePlayer_Params.PC), &PC, sizeof(PC));
...
void AGameCrowdAgent::OnPlayAgentAnimation(class USeqAct_PlayAgentAnimation* Action)
{
	...
	memcpy_s(&OnPlayAgentAnimation_Params.Action, sizeof(OnPlayAgentAnimation_Params.Action), &Action, sizeof(Action));
...
void AGameCrowdAgent::InitializeAgent(class AActor* SpawnLoc, class AGameCrowdAgent* AgentTemplate, class UGameCrowdGroup* NewGroup, float AgentWarmupTime, bool bWarmupPosition, bool bCheckWarmupVisibility, TArray<struct FCrowdSpawnerPlayerInfo>& PlayerInfo)
{
	...
	memcpy_s(&InitializeAgent_Params.SpawnLoc, sizeof(InitializeAgent_Params.SpawnLoc), &SpawnLoc, sizeof(SpawnLoc));
	memcpy_s(&InitializeAgent_Params.AgentTemplate, sizeof(InitializeAgent_Params.AgentTemplate), &AgentTemplate, sizeof(AgentTemplate));
	memcpy_s(&InitializeAgent_Params.NewGroup, sizeof(InitializeAgent_Params.NewGroup), &NewGroup, sizeof(NewGroup));
...
void AGameCrowdAgent::SetLighting(bool bEnableLightEnvironment, struct FLightingChannelContainer AgentLightingChannel, bool bCastShadows)
{
...
void AGameCrowdAgent::eventSetCurrentDestination(class AGameCrowdDestination* NewDest)
{
	...
	memcpy_s(&SetCurrentDestination_Params.NewDest, sizeof(SetCurrentDestination_Params.NewDest), &NewDest, sizeof(NewDest));
...
bool UGameCrowdAgentBehavior::AllowBehaviorAt(class AGameCrowdDestination* Destination)
{
	...
	memcpy_s(&AllowBehaviorAt_Params.Destination, sizeof(AllowBehaviorAt_Params.Destination), &Destination, sizeof(Destination));
...
bool UGameCrowdAgentBehavior::AllowThisDestination(class AGameCrowdDestination* Destination)
{
	...
	memcpy_s(&AllowThisDestination_Params.Destination, sizeof(AllowThisDestination_Params.Destination), &Destination, sizeof(Destination));
...
void UGameCrowdAgentBehavior::eventPropagateViralBehaviorTo(class AGameCrowdAgent* OtherAgent)
{
	...
	memcpy_s(&PropagateViralBehaviorTo_Params.OtherAgent, sizeof(PropagateViralBehaviorTo_Params.OtherAgent), &OtherAgent, sizeof(OtherAgent));
...
void UGameCrowdAgentBehavior::ActivatedBy(class AActor* NewActionTarget)
{
	...
	memcpy_s(&ActivatedBy_Params.NewActionTarget, sizeof(ActivatedBy_Params.NewActionTarget), &NewActionTarget, sizeof(NewActionTarget));
...
void UGameCrowdAgentBehavior::ChangingDestination(class AGameCrowdDestination* NewDest)
{
	...
	memcpy_s(&ChangingDestination_Params.NewDest, sizeof(ChangingDestination_Params.NewDest), &NewDest, sizeof(NewDest));
...
void UGameCrowdAgentBehavior::InitBehavior(class AGameCrowdAgent* Agent)
{
	...
	memcpy_s(&InitBehavior_Params.Agent, sizeof(InitBehavior_Params.Agent), &Agent, sizeof(Agent));
...
bool UGameCrowdAgentBehavior::CanBeUsedBy(class AGameCrowdAgent* Agent, struct FVector CameraLoc)
{
	...
	memcpy_s(&CanBeUsedBy_Params.Agent, sizeof(CanBeUsedBy_Params.Agent), &Agent, sizeof(Agent));
...
class AGameCrowdBehaviorPoint* UGameCrowdAgentBehavior::TriggerCrowdBehavior(ECrowdBehaviorEvent EventType, class AActor* Instigator, struct FVector AtLocation, float InRange, float InDuration, class AActor* BaseActor, bool bRequireLOS)
{
	...
	memcpy_s(&TriggerCrowdBehavior_Params.Instigator, sizeof(TriggerCrowdBehavior_Params.Instigator), &Instigator, sizeof(Instigator));
	...
	memcpy_s(&TriggerCrowdBehavior_Params.BaseActor, sizeof(TriggerCrowdBehavior_Params.BaseActor), &BaseActor, sizeof(BaseActor));
...
void UGameCrowdGroup::UpdateDestinations(class AGameCrowdDestination* NewDestination)
{
	...
	memcpy_s(&UpdateDestinations_Params.NewDestination, sizeof(UpdateDestinations_Params.NewDestination), &NewDestination, sizeof(NewDestination));
...
void UGameCrowdGroup::RemoveMember(class AGameCrowdAgent* Agent)
{
	...
	memcpy_s(&RemoveMember_Params.Agent, sizeof(RemoveMember_Params.Agent), &Agent, sizeof(Agent));
...
void UGameCrowdGroup::AddMember(class AGameCrowdAgent* Agent)
{
	...
	memcpy_s(&AddMember_Params.Agent, sizeof(AddMember_Params.Agent), &Agent, sizeof(Agent));
...
void AGameCrowdDestination::DrawDebug(bool bPersistent, TArray<struct FCrowdSpawnerPlayerInfo>& PlayerInfo)
{
	static UFunction* uFnDrawDebug = nullptr;
	...
	memset(&DrawDebug_Params, 0, sizeof(DrawDebug_Params));
	DrawDebug_Params.bPersistent = bPersistent;
...
bool AGameCrowdDestination::AnalyzeSpawnPoint(float MaxSpawnDistSq, bool bForceNavMeshPathing, class UNavigationHandle* NavHandle, TArray<struct FCrowdSpawnerPlayerInfo>& PlayerInfo)
{
	...
	memcpy_s(&AnalyzeSpawnPoint_Params.NavHandle, sizeof(AnalyzeSpawnPoint_Params.NavHandle), &NavHandle, sizeof(NavHandle));
...
void AGameCrowdDestination::GetSpawnPosition(class USeqAct_GameCrowdSpawner* Spawner, struct FVector& SpawnPos, struct FRotator& SpawnRot)
{
	...
	memcpy_s(&GetSpawnPosition_Params.Spawner, sizeof(GetSpawnPosition_Params.Spawner), &Spawner, sizeof(Spawner));
...
bool AGameCrowdDestination::eventAllowableDestinationFor(class AGameCrowdAgent* Agent)
{
	...
	memcpy_s(&AllowableDestinationFor_Params.Agent, sizeof(AllowableDestinationFor_Params.Agent), &Agent, sizeof(Agent));
...
void AGameCrowdDestination::eventIncrementCustomerCount(class AGameCrowdAgent* ArrivingAgent)
{
	...
	memcpy_s(&IncrementCustomerCount_Params.ArrivingAgent, sizeof(IncrementCustomerCount_Params.ArrivingAgent), &ArrivingAgent, sizeof(ArrivingAgent));
...
void AGameCrowdDestination::eventDecrementCustomerCount(class AGameCrowdAgent* DepartingAgent)
{
	...
	memcpy_s(&DecrementCustomerCount_Params.DepartingAgent, sizeof(DecrementCustomerCount_Params.DepartingAgent), &DepartingAgent, sizeof(DepartingAgent));
...
void AGameCrowdDestination::PickNewDestinationFor(class AGameCrowdAgent* Agent, bool bIgnoreRestrictions)
{
	...
	memcpy_s(&PickNewDestinationFor_Params.Agent, sizeof(PickNewDestinationFor_Params.Agent), &Agent, sizeof(Agent));
...
void AGameCrowdDestination::eventReachedDestination(class AGameCrowdAgent* Agent)
{
	...
	memcpy_s(&ReachedDestination_Params.Agent, sizeof(ReachedDestination_Params.Agent), &Agent, sizeof(Agent));
...
bool AGameCrowdDestination::ReachedByAgent(class AGameCrowdAgent* Agent, struct FVector TestPosition, bool bTestExactly)
{
	...
	memcpy_s(&ReachedByAgent_Params.Agent, sizeof(ReachedByAgent_Params.Agent), &Agent, sizeof(Agent));
...
void AGameCrowdDestinationQueuePoint::ClearQueue(class AGameCrowdAgent* OldCustomer)
{
	...
	memcpy_s(&ClearQueue_Params.OldCustomer, sizeof(ClearQueue_Params.OldCustomer), &OldCustomer, sizeof(OldCustomer));
...
void AGameCrowdDestinationQueuePoint::AddCustomer(class AGameCrowdAgent* NewCustomer, class AGameCrowdInteractionPoint* PreviousPosition)
{
	...
	memcpy_s(&AddCustomer_Params.NewCustomer, sizeof(AddCustomer_Params.NewCustomer), &NewCustomer, sizeof(NewCustomer));
	memcpy_s(&AddCustomer_Params.PreviousPosition, sizeof(AddCustomer_Params.PreviousPosition), &PreviousPosition, sizeof(PreviousPosition));
...
void AGameCrowdDestinationQueuePoint::AdvanceCustomerTo(class AGameCrowdInteractionPoint* FrontPosition)
{
	...
	memcpy_s(&AdvanceCustomerTo_Params.FrontPosition, sizeof(AdvanceCustomerTo_Params.FrontPosition), &FrontPosition, sizeof(FrontPosition));
...
bool AGameCrowdDestinationQueuePoint::QueueReachedBy(class AGameCrowdAgent* Agent, struct FVector TestPosition)
{
	...
	memcpy_s(&QueueReachedBy_Params.Agent, sizeof(QueueReachedBy_Params.Agent), &Agent, sizeof(Agent));
...
class AGameCrowdAgent* AGameCrowdPopulationManager::eventCreateNewAgent(class AGameCrowdDestination* SpawnLoc, class AGameCrowdAgent* AgentTemplate, class UGameCrowdGroup* NewGroup, struct FCrowdSpawnInfoItem& Item)
{
	...
	memcpy_s(&CreateNewAgent_Params.SpawnLoc, sizeof(CreateNewAgent_Params.SpawnLoc), &SpawnLoc, sizeof(SpawnLoc));
	memcpy_s(&CreateNewAgent_Params.AgentTemplate, sizeof(CreateNewAgent_Params.AgentTemplate), &AgentTemplate, sizeof(AgentTemplate));
	memcpy_s(&CreateNewAgent_Params.NewGroup, sizeof(CreateNewAgent_Params.NewGroup), &NewGroup, sizeof(NewGroup));
...
class AGameCrowdAgent* AGameCrowdPopulationManager::SpawnAgent(class AGameCrowdDestination* SpawnLoc, struct FCrowdSpawnInfoItem& Item)
{
	...
	memcpy_s(&SpawnAgent_Params.SpawnLoc, sizeof(SpawnAgent_Params.SpawnLoc), &SpawnLoc, sizeof(SpawnLoc));
...
class AGameCrowdAgent* AGameCrowdPopulationManager::SpawnAgentByIdx(int32_t SpawnerIdx, class AGameCrowdDestination* SpawnLoc)
{
	...
	memcpy_s(&SpawnAgentByIdx_Params.SpawnLoc, sizeof(SpawnAgentByIdx_Params.SpawnLoc), &SpawnLoc, sizeof(SpawnLoc));
...
bool AGameCrowdPopulationManager::ValidateSpawnAt(class AGameCrowdDestination* Candidate, struct FCrowdSpawnInfoItem& Item)
{
	...
	memcpy_s(&ValidateSpawnAt_Params.Candidate, sizeof(ValidateSpawnAt_Params.Candidate), &Candidate, sizeof(Candidate));
...
void AGameCrowdPopulationManager::AddPrioritizedSpawnPoint(class AGameCrowdDestination* GCD, struct FCrowdSpawnInfoItem& Item)
{
	...
	memcpy_s(&AddPrioritizedSpawnPoint_Params.GCD, sizeof(AddPrioritizedSpawnPoint_Params.GCD), &GCD, sizeof(GCD));
...
// [0x00422500] (FUNC_Simulated | FUNC_Native | FUNC_Static | FUNC_Public | FUNC_HasOutParms | FUNC_AllFlags)
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
...
void AGameCrowdPopulationManager::AgentDestroyed(class AGameCrowdAgent* Agent)
{
	...
	memcpy_s(&AgentDestroyed_Params.Agent, sizeof(AgentDestroyed_Params.Agent), &Agent, sizeof(Agent));
...
int32_t AGameCrowdPopulationManager::eventCreateSpawner(class USeqAct_GameCrowdPopulationManagerToggle* inAction)
{
	...
	memcpy_s(&CreateSpawner_Params.inAction, sizeof(CreateSpawner_Params.inAction), &inAction, sizeof(inAction));
...
void AGameCrowdPopulationManager::SetCrowdInfoVolume(class AGameCrowdInfoVolume* Vol)
{
	...
	memcpy_s(&SetCrowdInfoVolume_Params.Vol, sizeof(SetCrowdInfoVolume_Params.Vol), &Vol, sizeof(Vol));
...
void AGameCrowdPopulationManager::RemoveSpawnPoint(class AGameCrowdDestination* GCD)
{
	...
	memcpy_s(&RemoveSpawnPoint_Params.GCD, sizeof(RemoveSpawnPoint_Params.GCD), &GCD, sizeof(GCD));
...
void AGameCrowdPopulationManager::AddSpawnPoint(class AGameCrowdDestination* GCD)
{
	...
	memcpy_s(&AddSpawnPoint_Params.GCD, sizeof(AddSpawnPoint_Params.GCD), &GCD, sizeof(GCD));
...
class UCameraShake* AGameExplosionActor::ChooseCameraShake(struct FVector Epicenter, class APlayerController* PC)
{
	...
	memcpy_s(&ChooseCameraShake_Params.PC, sizeof(ChooseCameraShake_Params.PC), &PC, sizeof(PC));
...
void AGameExplosionActor::Explode(class UGameExplosion* NewExplosionTemplate, struct FVector Direction)
{
	...
	memcpy_s(&Explode_Params.NewExplosionTemplate, sizeof(Explode_Params.NewExplosionTemplate), &NewExplosionTemplate, sizeof(NewExplosionTemplate));
...
void AGameExplosionActor::SpawnExplosionParticleSystem(class UParticleSystem* Template)
{
	...
	memcpy_s(&SpawnExplosionParticleSystem_Params.Template, sizeof(SpawnExplosionParticleSystem_Params.Template), &Template, sizeof(Template));
...
void AGameExplosionActor::UpdateExplosionTemplateWithPerMaterialFX(class UPhysicalMaterial* PhysMaterial)
{
	...
	memcpy_s(&UpdateExplosionTemplateWithPerMaterialFX_Params.PhysMaterial, sizeof(UpdateExplosionTemplateWithPerMaterialFX_Params.PhysMaterial), &PhysMaterial, sizeof(PhysMaterial));
...
void AGameExplosionActor::SpecialCringeEffectsFor(class AActor* Victim, float VictimDist)
{
	...
	memcpy_s(&SpecialCringeEffectsFor_Params.Victim, sizeof(SpecialCringeEffectsFor_Params.Victim), &Victim, sizeof(Victim));
...
void AGameExplosionActor::SpecialPawnEffectsFor(class AGamePawn* VictimPawn, float VictimDist)
{
	...
	memcpy_s(&SpecialPawnEffectsFor_Params.VictimPawn, sizeof(SpecialPawnEffectsFor_Params.VictimPawn), &VictimPawn, sizeof(VictimPawn));
...
bool AGameExplosionActor::IsBehindExplosion(class AActor* A)
{
	...
	memcpy_s(&IsBehindExplosion_Params.A, sizeof(IsBehindExplosion_Params.A), &A, sizeof(A));
...
bool AGameExplosionActor::DoFullDamageToActor(class AActor* Victim)
{
	...
	memcpy_s(&DoFullDamageToActor_Params.Victim, sizeof(DoFullDamageToActor_Params.Victim), &Victim, sizeof(Victim));
...
class FString ADebugCameraController::ConsoleCommand(class FString Command, bool bWriteToLog)
{
...
bool ADebugCameraController::NativeInputKey(int32_t ControllerId, struct FName Key, EInputEvent Event, float AmountDepressed, bool bGamepad)
{
...
void ADebugCameraController::OnDeactivate(class APlayerController* PC)
{
	...
	memcpy_s(&OnDeactivate_Params.PC, sizeof(OnDeactivate_Params.PC), &PC, sizeof(PC));
...
void ADebugCameraController::OnActivate(class APlayerController* PC)
{
	...
	memcpy_s(&OnActivate_Params.PC, sizeof(OnActivate_Params.PC), &PC, sizeof(PC));
...
void AMobileHUD::AddKismetRenderEvent(class USeqEvent_HudRender* NewEvent)
{
	...
	memcpy_s(&AddKismetRenderEvent_Params.NewEvent, sizeof(AddKismetRenderEvent_Params.NewEvent), &NewEvent, sizeof(NewEvent));
...
void AMobileHUD::DrawMobileTilt(class UMobilePlayerInput* MobileInput)
{
	...
	memcpy_s(&DrawMobileTilt_Params.MobileInput, sizeof(DrawMobileTilt_Params.MobileInput), &MobileInput, sizeof(MobileInput));
...
void AMobileHUD::DrawMobileZone_Trackball(class UMobileInputZone* Zone)
{
	...
	memcpy_s(&DrawMobileZone_Trackball_Params.Zone, sizeof(DrawMobileZone_Trackball_Params.Zone), &Zone, sizeof(Zone));
...
void AMobileHUD::DrawMobileZone_Button(class UMobileInputZone* Zone)
{
	...
	memcpy_s(&DrawMobileZone_Button_Params.Zone, sizeof(DrawMobileZone_Button_Params.Zone), &Zone, sizeof(Zone));
...
void UMobileInputZone::AddKismetEventHandler(class USeqEvent_MobileZoneBase* NewHandler)
{
	...
	memcpy_s(&AddKismetEventHandler_Params.NewHandler, sizeof(AddKismetEventHandler_Params.NewHandler), &NewHandler, sizeof(NewHandler));
...
void UMobileInputZone::OnPostDrawZone(class UMobileInputZone* Zone, class UCanvas* Canvas)
{
	...
	memcpy_s(&OnPostDrawZone_Params.Zone, sizeof(OnPostDrawZone_Params.Zone), &Zone, sizeof(Zone));
	memcpy_s(&OnPostDrawZone_Params.Canvas, sizeof(OnPostDrawZone_Params.Canvas), &Canvas, sizeof(Canvas));
...
bool UMobileInputZone::OnPreDrawZone(class UMobileInputZone* Zone, class UCanvas* Canvas)
{
	...
	memcpy_s(&OnPreDrawZone_Params.Zone, sizeof(OnPreDrawZone_Params.Zone), &Zone, sizeof(Zone));
	memcpy_s(&OnPreDrawZone_Params.Canvas, sizeof(OnPreDrawZone_Params.Canvas), &Canvas, sizeof(Canvas));
...
bool UMobileInputZone::OnProcessSlide(class UMobileInputZone* Zone, ETouchType EventType, int32_t SlideValue, struct FVector2D ViewportSize)
{
	...
	memcpy_s(&OnProcessSlide_Params.Zone, sizeof(OnProcessSlide_Params.Zone), &Zone, sizeof(Zone));
...
bool UMobileInputZone::OnDoubleTapDelegate(class UMobileInputZone* Zone, ETouchType EventType, struct FVector2D TouchLocation)
{
	...
	memcpy_s(&OnDoubleTapDelegate_Params.Zone, sizeof(OnDoubleTapDelegate_Params.Zone), &Zone, sizeof(Zone));
...
bool UMobileInputZone::OnTapDelegate(class UMobileInputZone* Zone, ETouchType EventType, struct FVector2D TouchLocation)
{
	...
	memcpy_s(&OnTapDelegate_Params.Zone, sizeof(OnTapDelegate_Params.Zone), &Zone, sizeof(Zone));
...
bool UMobileInputZone::OnProcessInputDelegate(class UMobileInputZone* Zone, float DeltaTime, int32_t Handle, ETouchType EventType, struct FVector2D TouchLocation)
{
	...
	memcpy_s(&OnProcessInputDelegate_Params.Zone, sizeof(OnProcessInputDelegate_Params.Zone), &Zone, sizeof(Zone));
...
void UMobileMenuObject::RenderObject(class UCanvas* Canvas, float DeltaTime)
{
	...
	memcpy_s(&RenderObject_Params.Canvas, sizeof(RenderObject_Params.Canvas), &Canvas, sizeof(Canvas));
...
void UMobileMenuObject::SetCanvasPos(class UCanvas* Canvas, float OffsetX, float OffsetY)
{
	...
	memcpy_s(&SetCanvasPos_Params.Canvas, sizeof(SetCanvasPos_Params.Canvas), &Canvas, sizeof(Canvas));
...
void UMobileMenuObject::InitMenuObject(class UMobilePlayerInput* PlayerInput, class UMobileMenuScene* Scene, int32_t ScreenWidth, int32_t ScreenHeight, bool bIsFirstInitialization)
{
	...
	memcpy_s(&InitMenuObject_Params.PlayerInput, sizeof(InitMenuObject_Params.PlayerInput), &PlayerInput, sizeof(PlayerInput));
	memcpy_s(&InitMenuObject_Params.Scene, sizeof(InitMenuObject_Params.Scene), &Scene, sizeof(Scene));
...
bool UMobileMenuObject::eventOnTouch(ETouchType EventType, float TouchX, float TouchY, class UMobileMenuObject* ObjectOver, float DeltaTime)
{
	...
	memcpy_s(&OnTouch_Params.ObjectOver, sizeof(OnTouch_Params.ObjectOver), &ObjectOver, sizeof(ObjectOver));
...
void UMobileMenuScene::PreRenderMenuObject(class UMobileMenuObject* MenuObject, class UCanvas* Canvas, float RenderDelta)
{
	...
	memcpy_s(&PreRenderMenuObject_Params.MenuObject, sizeof(PreRenderMenuObject_Params.MenuObject), &MenuObject, sizeof(MenuObject));
	memcpy_s(&PreRenderMenuObject_Params.Canvas, sizeof(PreRenderMenuObject_Params.Canvas), &Canvas, sizeof(Canvas));
...
class UMobileMenuScene* UMobilePlayerInput::OpenMobileMenu(class FString MenuClassName)
{
...
void UMobilePlayerInput::PreClientTravel(class FString PendingURL, ETravelType TravelType, bool bIsSeamlessTravel)
{
...
void UMobilePlayerInput::eventRenderMenus(class UCanvas* Canvas, float RenderDelta)
{
	...
	memcpy_s(&RenderMenus_Params.Canvas, sizeof(RenderMenus_Params.Canvas), &Canvas, sizeof(Canvas));
...
void UMobilePlayerInput::eventCloseMenuScene(class UMobileMenuScene* SceneToClose)
{
	...
	memcpy_s(&CloseMenuScene_Params.SceneToClose, sizeof(CloseMenuScene_Params.SceneToClose), &SceneToClose, sizeof(SceneToClose));
...
class UMobileMenuScene* UMobilePlayerInput::eventOpenMenuScene(class UClass* SceneClass, class FString Mode)
{
	...
	memcpy_s(&OpenMenuScene_Params.SceneClass, sizeof(OpenMenuScene_Params.SceneClass), &SceneClass, sizeof(SceneClass));
...
void UMobilePlayerInput::AddKismetRawInputEventHandler(class USeqEvent_MobileRawInput* NewHandler)
{
	...
	memcpy_s(&AddKismetRawInputEventHandler_Params.NewHandler, sizeof(AddKismetRawInputEventHandler_Params.NewHandler), &NewHandler, sizeof(NewHandler));
...
bool UMobilePlayerInput::ProcessWorldTouch(class UMobileInputZone* Zone, ETouchType EventType, struct FVector2D TouchLocation)
{
	...
	memcpy_s(&ProcessWorldTouch_Params.Zone, sizeof(ProcessWorldTouch_Params.Zone), &Zone, sizeof(Zone));
...
void UMobilePlayerInput::SendInputKey(struct FName Key, EInputEvent Event, float AmountDepressed)
{
...
void UMobilePlayerInput::OnInputTouch(int32_t Handle, ETouchType Type, struct FVector2D TouchLocation, float DeviceTimestamp, int32_t TouchpadIndex)
{
...
bool UNavMeshGoal_OutOfViewFrom::MustBeHiddenFromThisPoint(class UNavigationHandle* NavHandle, struct FVector InOutOfViewLocation)
{
	...
	memcpy_s(&MustBeHiddenFromThisPoint_Params.NavHandle, sizeof(MustBeHiddenFromThisPoint_Params.NavHandle), &NavHandle, sizeof(NavHandle));
...
bool UNavMeshPath_BiasAgainstPolysWithinDistanceOfLocations::BiasAgainstPolysWithinDistanceOfLocations(class UNavigationHandle* NavHandle, struct FVector InLocation, struct FRotator InRotation, float InDistanceToCheck, TArray<struct FVector> InLocationsToCheck)
{
	...
	memcpy_s(&BiasAgainstPolysWithinDistanceOfLocations_Params.NavHandle, sizeof(BiasAgainstPolysWithinDistanceOfLocations_Params.NavHandle), &NavHandle, sizeof(NavHandle));
...
void USecondaryViewportClient::eventPostRender(class UCanvas* Canvas)
{
	...
	memset(&PostRender_Params, 0, sizeof(PostRender_Params));
	memcpy_s(&PostRender_Params.Canvas, sizeof(PostRender_Params.Canvas), &Canvas, sizeof(Canvas));
...
void USeqAct_GameCrowdPopulationManagerToggle::eventFillCrowdSpawnInfoItem(class AGameCrowdPopulationManager* PopMgr, struct FCrowdSpawnInfoItem& out_Item)
{
	...
	memcpy_s(&FillCrowdSpawnInfoItem_Params.PopMgr, sizeof(FillCrowdSpawnInfoItem_Params.PopMgr), &PopMgr, sizeof(PopMgr));
...
void USeqAct_PlayAgentAnimation::SetCurrentAnimationActionFor(class AGameCrowdAgentSkeletal* Agent)
{
	...
	memcpy_s(&SetCurrentAnimationActionFor_Params.Agent, sizeof(SetCurrentAnimationActionFor_Params.Agent), &Agent, sizeof(Agent));
...
void USeqEvent_HudRender::Render(class UCanvas* TargetCanvas, class AHUD* TargetHud)
{
	...
	memcpy_s(&Render_Params.TargetCanvas, sizeof(Render_Params.TargetCanvas), &TargetCanvas, sizeof(TargetCanvas));
	memcpy_s(&Render_Params.TargetHud, sizeof(Render_Params.TargetHud), &TargetHud, sizeof(TargetHud));
...
void USeqEvent_MobileBase::eventAddToMobileInput(class UMobilePlayerInput* MPI)
{
	...
	memcpy_s(&AddToMobileInput_Params.MPI, sizeof(AddToMobileInput_Params.MPI), &MPI, sizeof(MPI));
...
void UGameCameraBase::ProcessViewRotation(float DeltaTime, class AActor* ViewTarget, struct FRotator& out_ViewRotation, struct FRotator& out_DeltaRot)
{
	...
	memcpy_s(&ProcessViewRotation_Params.ViewTarget, sizeof(ProcessViewRotation_Params.ViewTarget), &ViewTarget, sizeof(ViewTarget));
...
void UGameCameraBase::UpdateCamera(class APawn* P, class AGamePlayerCamera* CameraActor, float DeltaTime, struct FTViewTarget& OutVT)
{
	...
	memcpy_s(&UpdateCamera_Params.P, sizeof(UpdateCamera_Params.P), &P, sizeof(P));
	memcpy_s(&UpdateCamera_Params.CameraActor, sizeof(UpdateCamera_Params.CameraActor), &CameraActor, sizeof(CameraActor));
...
void UGameCameraBase::OnBecomeInActive(class UGameCameraBase* NewCamera)
{
	...
	memcpy_s(&OnBecomeInActive_Params.NewCamera, sizeof(OnBecomeInActive_Params.NewCamera), &NewCamera, sizeof(NewCamera));
...
void UGameCameraBase::OnBecomeActive(class UGameCameraBase* OldCamera)
{
	...
	memcpy_s(&OnBecomeActive_Params.OldCamera, sizeof(OnBecomeActive_Params.OldCamera), &OldCamera, sizeof(OldCamera));
...
void UGameThirdPersonCamera::UpdateCameraMode(class APawn* P)
{
	...
	memcpy_s(&UpdateCameraMode_Params.P, sizeof(UpdateCameraMode_Params.P), &P, sizeof(P));
...
class UGameThirdPersonCameraMode* UGameThirdPersonCamera::FindBestCameraMode(class APawn* P)
{
	...
	memcpy_s(&FindBestCameraMode_Params.P, sizeof(FindBestCameraMode_Params.P), &P, sizeof(P));
...
void UGameThirdPersonCamera::eventUpdateFocusPoint(class APawn* P)
{
	...
	memcpy_s(&UpdateFocusPoint_Params.P, sizeof(UpdateFocusPoint_Params.P), &P, sizeof(P));
...
void UGameThirdPersonCamera::SetFocusOnActor(class AActor* FocusActor, struct FName FocusBoneName, struct FVector2D InterpSpeedRange, struct FVector2D InFocusFOV, float CameraFOV, bool bAlwaysFocus, bool bAdjustCamera, bool bIgnoreTrace, float FocusPitchOffsetDeg)
{
	...
	memcpy_s(&SetFocusOnActor_Params.FocusActor, sizeof(SetFocusOnActor_Params.FocusActor), &FocusActor, sizeof(FocusActor));
...
void UGameThirdPersonCamera::SetFocusOnLoc(struct FVector FocusWorldLoc, struct FVector2D InterpSpeedRange, struct FVector2D InFocusFOV, float CameraFOV, bool bAlwaysFocus, bool bAdjustCamera, bool bIgnoreTrace, float FocusPitchOffsetDeg)
{
...
void UGameThirdPersonCamera::PlayerUpdateCamera(class APawn* P, class AGamePlayerCamera* CameraActor, float DeltaTime, struct FTViewTarget& OutVT)
{
	...
	memcpy_s(&PlayerUpdateCamera_Params.P, sizeof(PlayerUpdateCamera_Params.P), &P, sizeof(P));
	memcpy_s(&PlayerUpdateCamera_Params.CameraActor, sizeof(PlayerUpdateCamera_Params.CameraActor), &CameraActor, sizeof(CameraActor));
...
float UGameThirdPersonCamera::eventGetDesiredFOV(class APawn* ViewedPawn)
{
	...
	memcpy_s(&GetDesiredFOV_Params.ViewedPawn, sizeof(GetDesiredFOV_Params.ViewedPawn), &ViewedPawn, sizeof(ViewedPawn));
...
class UGameThirdPersonCameraMode* UGameThirdPersonCamera::CreateCameraMode(class UClass* ModeClass)
{
	...
	memcpy_s(&CreateCameraMode_Params.ModeClass, sizeof(CreateCameraMode_Params.ModeClass), &ModeClass, sizeof(ModeClass));
...
float AGamePlayerCamera::AdjustFOVForViewport(float inHorizFOV, class APawn* CameraTargetPawn)
{
	...
	memcpy_s(&AdjustFOVForViewport_Params.CameraTargetPawn, sizeof(AdjustFOVForViewport_Params.CameraTargetPawn), &CameraTargetPawn, sizeof(CameraTargetPawn));
...
class UGameCameraBase* AGamePlayerCamera::FindBestCameraType(class AActor* CameraTarget)
{
	...
	memcpy_s(&FindBestCameraType_Params.CameraTarget, sizeof(FindBestCameraType_Params.CameraTarget), &CameraTarget, sizeof(CameraTarget));
...
void AGamePlayerCamera::CacheLastTargetBaseInfo(class AActor* TargetBase)
{
	...
	memcpy_s(&CacheLastTargetBaseInfo_Params.TargetBase, sizeof(CacheLastTargetBaseInfo_Params.TargetBase), &TargetBase, sizeof(TargetBase));
...
class UGameCameraBase* AGamePlayerCamera::CreateCamera(class UClass* CameraClass)
{
	...
	memcpy_s(&CreateCamera_Params.CameraClass, sizeof(CreateCamera_Params.CameraClass), &CameraClass, sizeof(CameraClass));
...
struct FVector UGameThirdPersonCameraMode::DOFTrace(class AActor* TraceOwner, struct FVector StartTrace, struct FVector EndTrace)
{
	...
	memcpy_s(&DOFTrace_Params.TraceOwner, sizeof(DOFTrace_Params.TraceOwner), &TraceOwner, sizeof(TraceOwner));
...
struct FVector UGameThirdPersonCameraMode::GetDOFFocusLoc(class AActor* TraceOwner, struct FVector StartTrace, struct FVector EndTrace)
{
	...
	memcpy_s(&GetDOFFocusLoc_Params.TraceOwner, sizeof(GetDOFFocusLoc_Params.TraceOwner), &TraceOwner, sizeof(TraceOwner));
...
bool UGameThirdPersonCameraMode::SetFocusPoint(class APawn* ViewedPawn)
{
	...
	memcpy_s(&SetFocusPoint_Params.ViewedPawn, sizeof(SetFocusPoint_Params.ViewedPawn), &ViewedPawn, sizeof(ViewedPawn));
...
struct FVector UGameThirdPersonCameraMode::eventGetCameraWorstCaseLoc(class APawn* TargetPawn, struct FTViewTarget CurrentViewTarget)
{
	...
	memcpy_s(&GetCameraWorstCaseLoc_Params.TargetPawn, sizeof(GetCameraWorstCaseLoc_Params.TargetPawn), &TargetPawn, sizeof(TargetPawn));
...
struct FVector UGameThirdPersonCameraMode::eventAdjustViewOffset(class APawn* P, struct FVector Offset)
{
	...
	memcpy_s(&AdjustViewOffset_Params.P, sizeof(AdjustViewOffset_Params.P), &P, sizeof(P));
...
void UGameThirdPersonCameraMode::OnBecomeInActive(class APawn* TargetPawn, class UGameThirdPersonCameraMode* NewMode)
{
	...
	memset(&OnBecomeInActive_Params, 0, sizeof(OnBecomeInActive_Params));
	memcpy_s(&OnBecomeInActive_Params.TargetPawn, sizeof(OnBecomeInActive_Params.TargetPawn), &TargetPawn, sizeof(TargetPawn));
	memcpy_s(&OnBecomeInActive_Params.NewMode, sizeof(OnBecomeInActive_Params.NewMode), &NewMode, sizeof(NewMode));
...
void UGameThirdPersonCameraMode::OnBecomeActive(class APawn* TargetPawn, class UGameThirdPersonCameraMode* PrevMode)
{
	...
	memset(&OnBecomeActive_Params, 0, sizeof(OnBecomeActive_Params));
	memcpy_s(&OnBecomeActive_Params.TargetPawn, sizeof(OnBecomeActive_Params.TargetPawn), &TargetPawn, sizeof(TargetPawn));
	memcpy_s(&OnBecomeActive_Params.PrevMode, sizeof(OnBecomeActive_Params.PrevMode), &PrevMode, sizeof(PrevMode));
...
void UGameSpecialMove::ForcePawnRotation(class APawn* P, struct FRotator NewRotation)
{
	...
	memcpy_s(&ForcePawnRotation_Params.P, sizeof(ForcePawnRotation_Params.P), &P, sizeof(P));
...
bool UGameSpecialMove::MessageEvent(struct FName EventName, class UObject* Sender)
{
	...
	memcpy_s(&MessageEvent_Params.Sender, sizeof(MessageEvent_Params.Sender), &Sender, sizeof(Sender));
...
void UGameSpecialMove::SetReachPreciseDestination(struct FVector DestinationToReach, bool bCancel)
{
...
void UGameSpecialMove::SpecialMoveStarted(bool bForced, struct FName PrevMove)
{
...
void UGameSpecialMove::InitSpecialMove(class AGamePawn* inPawn, struct FName InHandle)
{
	...
	memcpy_s(&InitSpecialMove_Params.inPawn, sizeof(InitSpecialMove_Params.inPawn), &inPawn, sizeof(inPawn));
...
bool ADebugCameraHUD::DisplayMaterials(float X, float DY, class UMeshComponent* MeshComp, float& Y)
{
	...
	memcpy_s(&DisplayMaterials_Params.MeshComp, sizeof(DisplayMaterials_Params.MeshComp), &MeshComp, sizeof(MeshComp));
...
bool UDebugCameraInput::InputKey(int32_t ControllerId, struct FName Key, EInputEvent Event, float AmountDepressed, bool bGamepad)
{
...
bool UGameAICmd_Hover_MoveToGoal::IsEnemyBasedOnInterpActor(class APawn* InEnemy)
{
	...
	memcpy_s(&IsEnemyBasedOnInterpActor_Params.InEnemy, sizeof(IsEnemyBasedOnInterpActor_Params.InEnemy), &InEnemy, sizeof(InEnemy));
...
bool UGameAICmd_Hover_MoveToGoal::MoveToGoal(class AGameAIController* AI, class AActor* InGoal, float InGoalDistance, float InHoverHeight)
{
	...
	memcpy_s(&MoveToGoal_Params.AI, sizeof(MoveToGoal_Params.AI), &AI, sizeof(AI));
	memcpy_s(&MoveToGoal_Params.InGoal, sizeof(MoveToGoal_Params.InGoal), &InGoal, sizeof(InGoal));
...
bool UGameAICmd_Hover_MoveToGoal_Mesh::HoverBackToMesh(class AGameAIController* AI)
{
	...
	memcpy_s(&HoverBackToMesh_Params.AI, sizeof(HoverBackToMesh_Params.AI), &AI, sizeof(AI));
...
bool UGameAICmd_Hover_MoveToGoal_Mesh::HoverToPoint(class AGameAIController* AI, struct FVector InPoint, float InGoalDistance, float InHoverHeight)
{
	...
	memcpy_s(&HoverToPoint_Params.AI, sizeof(HoverToPoint_Params.AI), &AI, sizeof(AI));
...
bool UGameAICmd_Hover_MoveToGoal_Mesh::HoverToGoal(class AGameAIController* AI, class AActor* InGoal, float InGoalDistance, float InHoverHeight)
{
	...
	memcpy_s(&HoverToGoal_Params.AI, sizeof(HoverToGoal_Params.AI), &AI, sizeof(AI));
	memcpy_s(&HoverToGoal_Params.InGoal, sizeof(HoverToGoal_Params.InGoal), &InGoal, sizeof(InGoal));
...
bool UMobileDebugCameraInput::InputKey(int32_t ControllerId, struct FName Key, EInputEvent Event, float AmountDepressed, bool bGamepad)
{
	static UFunction* uFnInputKey = nullptr;
...
void UMobileMenuBar::RenderItem(class UCanvas* Canvas, float DeltaTime, int32_t ItemIndex)
{
	...
	memcpy_s(&RenderItem_Params.Canvas, sizeof(RenderItem_Params.Canvas), &Canvas, sizeof(Canvas));
...
void UMobileMenuBar::AddItem(class UMobileMenuBarItem* Item, int32_t Index)
{
	...
	memcpy_s(&AddItem_Params.Item, sizeof(AddItem_Params.Item), &Item, sizeof(Item));
...
void UMobileMenuBarItem::RenderItem(class UMobileMenuBar* Bar, class UCanvas* Canvas, float DeltaTime)
{
	...
	memset(&RenderItem_Params, 0, sizeof(RenderItem_Params));
	memcpy_s(&RenderItem_Params.Bar, sizeof(RenderItem_Params.Bar), &Bar, sizeof(Bar));
	memcpy_s(&RenderItem_Params.Canvas, sizeof(RenderItem_Params.Canvas), &Canvas, sizeof(Canvas));
	memcpy_s(&RenderItem_Params.DeltaTime, sizeof(RenderItem_Params.DeltaTime), &DeltaTime, sizeof(DeltaTime));
...
void UMobileMenuButton::RenderCaption(class UCanvas* Canvas)
{
	...
	memcpy_s(&RenderCaption_Params.Canvas, sizeof(RenderCaption_Params.Canvas), &Canvas, sizeof(Canvas));
...
void UMobileMenuElement::RenderElement(class UMobileMenuObject* Owner, class UCanvas* Canvas, float DeltaTime, float Opacity)
{
	...
	memcpy_s(&RenderElement_Params.Owner, sizeof(RenderElement_Params.Owner), &Owner, sizeof(Owner));
	memcpy_s(&RenderElement_Params.Canvas, sizeof(RenderElement_Params.Canvas), &Canvas, sizeof(Canvas));
...
void AMobileMenuGame::eventPostLogin(class APlayerController* NewPlayer)
{
	...
	memcpy_s(&PostLogin_Params.NewPlayer, sizeof(PostLogin_Params.NewPlayer), &NewPlayer, sizeof(NewPlayer));
...
void UMobileMenuInventory::RenderDragItem(class UCanvas* Canvas, float DeltaTime)
{
	...
	memcpy_s(&RenderDragItem_Params.Canvas, sizeof(RenderDragItem_Params.Canvas), &Canvas, sizeof(Canvas));
...
int32_t UMobileMenuInventory::GetIndexOfItem(class UMobileMenuElement* Item)
{
	...
	memcpy_s(&GetIndexOfItem_Params.Item, sizeof(GetIndexOfItem_Params.Item), &Item, sizeof(Item));
...
class UMobileMenuElement* UMobileMenuInventory::AddItemToSlot(class UMobileMenuElement* Element, int32_t ToSlot)
{
	...
	memcpy_s(&AddItemToSlot_Params.Element, sizeof(AddItemToSlot_Params.Element), &Element, sizeof(Element));
...
bool UMobileMenuInventory::CanPutItemInSlot(class UMobileMenuElement* Item, class UMobileMenuElement* ToSlot, int32_t ToIdx, int32_t FromIdx)
{
	...
	memcpy_s(&CanPutItemInSlot_Params.Item, sizeof(CanPutItemInSlot_Params.Item), &Item, sizeof(Item));
	memcpy_s(&CanPutItemInSlot_Params.ToSlot, sizeof(CanPutItemInSlot_Params.ToSlot), &ToSlot, sizeof(ToSlot));
...
void UMobileMenuInventory::ScaleSlot(class UMobileMenuElement* Slot)
{
	...
	memcpy_s(&ScaleSlot_Params.Slot, sizeof(ScaleSlot_Params.Slot), &Slot, sizeof(Slot));
...
int32_t UMobileMenuInventory::AddSlot(class UMobileMenuElement* Slot)
{
	...
	memcpy_s(&AddSlot_Params.Slot, sizeof(AddSlot_Params.Slot), &Slot, sizeof(Slot));
...
bool UMobileMenuInventory::DoCanPutItemInSlot(class UMobileMenuInventory* FromInv, class UMobileMenuElement* Item, class UMobileMenuElement* ToSlot, int32_t ToIdx, int32_t FromIdx)
{
	...
	memcpy_s(&DoCanPutItemInSlot_Params.FromInv, sizeof(DoCanPutItemInSlot_Params.FromInv), &FromInv, sizeof(FromInv));
	memcpy_s(&DoCanPutItemInSlot_Params.Item, sizeof(DoCanPutItemInSlot_Params.Item), &Item, sizeof(Item));
	memcpy_s(&DoCanPutItemInSlot_Params.ToSlot, sizeof(DoCanPutItemInSlot_Params.ToSlot), &ToSlot, sizeof(ToSlot));
...
void UMobileMenuInventory::OnUpdateItemInSlot(class UMobileMenuInventory* FromInv, int32_t SlotIndex)
{
	...
	memcpy_s(&OnUpdateItemInSlot_Params.FromInv, sizeof(OnUpdateItemInSlot_Params.FromInv), &FromInv, sizeof(FromInv));
...
int32_t UMobileMenuList::ItemScrollSize(class UMobileMenuListItem* Item)
{
	...
	memcpy_s(&ItemScrollSize_Params.Item, sizeof(ItemScrollSize_Params.Item), &Item, sizeof(Item));
...
float UMobileMenuList::GetAmountSelected(class UMobileMenuListItem* Item)
{
	...
	memcpy_s(&GetAmountSelected_Params.Item, sizeof(GetAmountSelected_Params.Item), &Item, sizeof(Item));
...
void UMobileMenuListItem::RenderItem(class UMobileMenuList* List, class UCanvas* Canvas, float DeltaTime)
{
	...
	memset(&RenderItem_Params, 0, sizeof(RenderItem_Params));
	memcpy_s(&RenderItem_Params.List, sizeof(RenderItem_Params.List), &List, sizeof(List));
	memcpy_s(&RenderItem_Params.Canvas, sizeof(RenderItem_Params.Canvas), &Canvas, sizeof(Canvas));
	memcpy_s(&RenderItem_Params.DeltaTime, sizeof(RenderItem_Params.DeltaTime), &DeltaTime, sizeof(DeltaTime));
...
void UMobileMenuObjectProxy::OnRenderObject(class UMobileMenuObjectProxy* Proxy, class UCanvas* Canvas, float DeltaTime)
{
	...
	memcpy_s(&OnRenderObject_Params.Proxy, sizeof(OnRenderObject_Params.Proxy), &Proxy, sizeof(Proxy));
	memcpy_s(&OnRenderObject_Params.Canvas, sizeof(OnRenderObject_Params.Canvas), &Canvas, sizeof(Canvas));
...
bool UMobileMenuObjectProxy::OnTouchEvent(class UMobileMenuObjectProxy* Proxy, ETouchType EventType, float TouchX, float TouchY, class UMobileMenuObject* ObjectOver, float DeltaTime)
{
	...
	memcpy_s(&OnTouchEvent_Params.Proxy, sizeof(OnTouchEvent_Params.Proxy), &Proxy, sizeof(Proxy));
	...
	memcpy_s(&OnTouchEvent_Params.ObjectOver, sizeof(OnTouchEvent_Params.ObjectOver), &ObjectOver, sizeof(ObjectOver));
...
void AMobileTouchInputVolume::OnToggle(class USeqAct_Toggle* inAction)
{
	...
	memset(&OnToggle_Params, 0, sizeof(OnToggle_Params));
	memcpy_s(&OnToggle_Params.inAction, sizeof(OnToggle_Params.inAction), &inAction, sizeof(inAction));
...
void APlayerCollectorGame::eventGetSeamlessTravelActorList(bool bToEntry, TArray<class AActor*>& ActorList)
{
