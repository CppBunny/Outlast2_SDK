...
// ScriptStruct Core.Object.GameFlowRuleVisibility
// 0x0014
struct FGameFlowRuleVisibility
{
...
// ScriptStruct Core.Object.GameFlowRuleEnable
// 0x0014
struct FGameFlowRuleEnable
{
	uint8_t                                            Action;                                        // 0x0000 (0x0001) [0x0000000000000001] (CPF_Edit)    
	uint8_t                                            Condition;                                     // 0x0001 (0x0001) [0x0000000000000001] (CPF_Edit)    
	struct FName                                       ControlName;                                   // 0x0004 (0x0008) [0x0000000000000001] (CPF_Edit)    
...
// ScriptStruct Core.Object.SpinLock
// 0x0004
struct FSpinLock
{
	int32_t                                            Counter;                                       // 0x0000 (0x0004) [0x0000000000000002] (CPF_Const)   
};
...
struct FUntypedBulkData_Mirror
{
	...
	struct FQWord                                      BulkDataOffsetInFile;                          // 0x0010 (0x0008) [0x0000000000001002] (CPF_Const | CPF_Native)
	struct FQWord                                      BulkDataSizeOnDisk;                            // 0x0018 (0x0008) [0x0000000000001002] (CPF_Const | CPF_Native)
	int32_t                                            SavedBulkDataFlags;                            // 0x0020 (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
	int32_t                                            SavedElementCount;                             // 0x0024 (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
	struct FQWord                                      SavedBulkDataOffsetInFile;                     // 0x0028 (0x0008) [0x0000000000001002] (CPF_Const | CPF_Native)
	struct FQWord                                      SavedBulkDataSizeOnDisk;                       // 0x0030 (0x0008) [0x0000000000001002] (CPF_Const | CPF_Native)
	...
	struct FPointer                                    AttachedAr;                                    // 0x0044 (0x0008) [0x0000000000001002] (CPF_Const | CPF_Native)
	int32_t                                            bShouldFreeOnEmpty;                            // 0x004C (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
};
...
struct FSet_Mirror
{
	...
	int32_t                                            HashSize;                                      // 0x0044 (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
};
...
struct FHatPointer
{
	int32_t                                            Dummy;                                         // 0x0000 (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
};
