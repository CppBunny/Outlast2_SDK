...
{
public:
	TArray<struct FGCReference>                        GCReferences;                                  // 0x0068 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	int32_t                                            RefCount;                                      // 0x0078 (0x0004) [0x0000000000002000] (CPF_Transient)
...
// 0x000C OR 0x00C4 (0x00C4 - 0x00B8)
// 12 OR 196 (196 - 184)
...
public:
	...
	uint32_t                                           bFakeMobileTouches : 1;                        // 0x00C0 (0x0004) [0x0000000000000000] [0x00000001] 
...
// 0x0184 OR 0x01EC (0x01EC - 0x0068)
// 388 OR 492 (492 - 104)
class UGFxMoviePlayer : public UObject
{
public:
	struct FPointer                                    pMovie;                                        // 0x0068 (0x0008) [0x0000000000003002] (CPF_Const | CPF_Native | CPF_Transient)
	struct FPointer                                    pCaptureKeys;                                  // 0x0070 (0x0008) [0x0000000000003002] (CPF_Const | CPF_Native | CPF_Transient)
	struct FPointer                                    pFocusIgnoreKeys;                              // 0x0078 (0x0008) [0x0000000000003002] (CPF_Const | CPF_Native | CPF_Transient)
	uint8_t                                           UnknownData00[0x48];                           // 0x0080 (0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.ASUClasses
	uint8_t                                           UnknownData01[0x48];                           // 0x00C8 (0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.ASUObjects
	int32_t                                            NextASUObject;                                 // 0x0110 (0x0004) [0x0000000000002002] (CPF_Const | CPF_Transient)
	class USwfMovie*                                   MovieInfo;                                     // 0x0114 (0x0008) [0x0000000000000000]               
	uint32_t                                           bMovieIsOpen : 1;                              // 0x011C (0x0004) [0x0000000000000002] [0x00000001] (CPF_Const)
	uint32_t                                           bDisplayWithHudOff : 1;                        // 0x011C (0x0004) [0x0000000000000000] [0x00000002] 
	uint32_t                                           bEnableGammaCorrection : 1;                    // 0x011C (0x0004) [0x0000000000000000] [0x00000004] 
	uint32_t                                           bWidgetsInitializedThisFrame : 1;              // 0x011C (0x0004) [0x0000000000002002] [0x00000008] (CPF_Const | CPF_Transient)
	uint32_t                                           bLogUnhandedWidgetInitializations : 1;         // 0x011C (0x0004) [0x0000000000000000] [0x00000010] 
	uint32_t                                           bAllowInput : 1;                               // 0x011C (0x0004) [0x0000000000000000] [0x00000020] 
	uint32_t                                           bAllowFocus : 1;                               // 0x011C (0x0004) [0x0000000000000000] [0x00000040] 
	uint32_t                                           bConvertMovmentInputToUIInput : 1;             // 0x011C (0x0004) [0x0000000000000000] [0x00000080] 
	uint32_t                                           bAutoPlay : 1;                                 // 0x011C (0x0004) [0x0000000000000000] [0x00000100] 
	uint32_t                                           bPauseGameWhileActive : 1;                     // 0x011C (0x0004) [0x0000000000000000] [0x00000200] 
	uint32_t                                           bDisableWorldRendering : 1;                    // 0x011C (0x0004) [0x0000000000000000] [0x00000400] 
	uint32_t                                           bCaptureWorldRendering : 1;                    // 0x011C (0x0004) [0x0000000000000000] [0x00000800] 
	uint32_t                                           bCloseOnLevelChange : 1;                       // 0x011C (0x0004) [0x0000000000000000] [0x00001000] 
	uint32_t                                           bOnlyOwnerFocusable : 1;                       // 0x011C (0x0004) [0x0000000000000000] [0x00002000] 
	uint32_t                                           bForceFullViewport : 1;                        // 0x011C (0x0004) [0x0000000000000000] [0x00004000] 
	uint32_t                                           bDiscardNonOwnerInput : 1;                     // 0x011C (0x0004) [0x0000000000000000] [0x00008000] 
	uint32_t                                           bCaptureInput : 1;                             // 0x011C (0x0004) [0x0000000000000000] [0x00010000] 
	uint32_t                                           bCaptureMouseInput : 1;                        // 0x011C (0x0004) [0x0000000000000000] [0x00020000] 
	uint32_t                                           bIgnoreMouseInput : 1;                         // 0x011C (0x0004) [0x0000000000000000] [0x00040000] 
	uint32_t                                           bIsSplitscreenLayoutModified : 1;              // 0x011C (0x0004) [0x0000000000002000] [0x00080000] (CPF_Transient)
	uint32_t                                           bShowHardwareMouseCursor : 1;                  // 0x011C (0x0004) [0x0000000000000000] [0x00100000] 
	uint32_t                                           bBlurLesserMovies : 1;                         // 0x011C (0x0004) [0x0000000000000000] [0x00200000] 
	uint32_t                                           bHideLesserMovies : 1;                         // 0x011C (0x0004) [0x0000000000000000] [0x00400000] 
	uint32_t                                           bIsPriorityBlurred : 1;                        // 0x011C (0x0004) [0x0000000000000000] [0x00800000] 
	uint32_t                                           bIsPriorityHidden : 1;                         // 0x011C (0x0004) [0x0000000000000000] [0x01000000] 
	uint32_t                                           bIgnoreVisibilityEffect : 1;                   // 0x011C (0x0004) [0x0000000000000000] [0x02000000] 
	uint32_t                                           bIgnoreBlurEffect : 1;                         // 0x011C (0x0004) [0x0000000000000000] [0x04000000] 
	class UTextureRenderTarget2D*                      RenderTexture;                                 // 0x0120 (0x0008) [0x0000000000000001] (CPF_Edit)    
	int32_t                                            LocalPlayerOwnerIndex;                         // 0x0128 (0x0004) [0x0000000000002000] (CPF_Transient)
	class UObject*                                     ExternalInterface;                             // 0x012C (0x0008) [0x0000000000000000]               
	TArray<struct FName>                               CaptureKeys;                                   // 0x0134 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	TArray<struct FName>                               FocusIgnoreKeys;                               // 0x0144 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	TArray<struct FExternalTexture>                    ExternalTextures;                              // 0x0154 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	TArray<struct FSoundThemeBinding>                  SoundThemes;                                   // 0x0164 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	EGFxTimingMode                                     TimingMode;                                    // 0x0174 (0x0001) [0x0000000000000000]               
	EGFxRenderTextureMode                              RenderTextureMode;                             // 0x0175 (0x0001) [0x0000000000000000]               
	uint8_t                                            Priority;                                      // 0x0176 (0x0001) [0x0000000000000000]               
	TArray<struct FGFxWidgetBinding>                   WidgetBindings;                                // 0x0178 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	uint8_t                                           UnknownData02[0x48];                           // 0x0188 (0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.WidgetPathBindings
	class UGFxObject*                                  SplitscreenLayoutObject;                       // 0x01D0 (0x0008) [0x0000000000002000] (CPF_Transient)
	int32_t                                            SplitscreenLayoutYAdjust;                      // 0x01D8 (0x0004) [0x0000000000004000] (CPF_Config)  
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                     // 0x01DC (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	void PlaySoundFromTheme(struct FName EventName, struct FName optionalSoundThemeName);
	...
	void SetMovieConvertMovementInputToUIInput(bool bConvertInput);
...
{
public:
	int32_t                                            Value[0xC];                                    // 0x0068 (0x0030) [0x0000000000001002] (CPF_Const | CPF_Native)
	TArray<struct FGFxWidgetBinding>                   SubWidgetBindings;                             // 0x0098 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
public:
	TArray<uint8_t>                                    RawData;                                       // 0x0068 (0x0010) [0x0000000000400002] (CPF_Const | CPF_NeedCtorLink)
	TArray<class FString>                              ReferencedSwfs;                                // 0x0078 (0x0010) [0x0000000000420001] (CPF_Edit | CPF_EditConst | CPF_NeedCtorLink)
	TArray<class UObject*>                             References;                                    // 0x0088 (0x0010) [0x0000000000420001] (CPF_Edit | CPF_EditConst | CPF_NeedCtorLink)
	TArray<class UObject*>                             UserReferences;                                // 0x0098 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
// 0x004C OR 0x00F4 (0x00F4 - 0x00A8)
// 76 OR 244 (244 - 168)
class USwfMovie : public UGFxRawData
{
public:
	uint32_t                                           bUsesFontlib : 1;                              // 0x00A8 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
	uint32_t                                           bSetSRGBOnImportedTextures : 1;                // 0x00A8 (0x0004) [0x0000000000020001] [0x00000002] (CPF_Edit | CPF_EditConst)
	uint32_t                                           bPackTextures : 1;                             // 0x00A8 (0x0004) [0x0000000000000001] [0x00000004] (CPF_Edit)
	uint32_t                                           bForceSquarePacking : 1;                       // 0x00A8 (0x0004) [0x0000000000000001] [0x00000008] (CPF_Edit)
	class FString                                      SourceFile;                                    // 0x00AC (0x0010) [0x0000000800400001] (CPF_Edit | CPF_NeedCtorLink)
	int32_t                                            PackTextureSize;                               // 0x00BC (0x0004) [0x0000000000000001] (CPF_Edit)    
	EFlashTextureRescale                               TextureRescale;                                // 0x00C0 (0x0001) [0x0000000000000001] (CPF_Edit)    
	class FString                                      TextureFormat;                                 // 0x00C4 (0x0010) [0x0000000000420001] (CPF_Edit | CPF_EditConst | CPF_NeedCtorLink)
	class FString                                      SourceFileTimestamp;                           // 0x00D4 (0x0010) [0x0000000800420001] (CPF_Edit | CPF_EditConst | CPF_NeedCtorLink)
	int32_t                                            RTTextures;                                    // 0x00E4 (0x0004) [0x0000000000000000]               
	int32_t                                            RTVideoTextures;                               // 0x00E8 (0x0004) [0x0000000000000000]               
	struct FQWord                                      ImportTimeStamp;                               // 0x00EC (0x0008) [0x0000000800002002] (CPF_Const | CPF_Transient)
...
// 0x0000 OR 0x00F4 (0x00F4 - 0x00F4)
// 0 OR 244 (244 - 244)
...
{
public:
	class UGFxMoviePlayer*                             Movie;                                         // 0x0158 (0x0008) [0x0000000000000000]               
	uint32_t                                           bUnload : 1;                                   // 0x0160 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
...
public:
	class UGFxMoviePlayer*                             Movie;                                         // 0x0158 (0x0008) [0x0000000000000000]               
	class FString                                      Variable;                                      // 0x0160 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
public:
	class UGFxMoviePlayer*                             Movie;                                         // 0x0158 (0x0008) [0x0000000000000000]               
	class FString                                      MethodName;                                    // 0x0160 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	TArray<struct FASValue>                            Arguments;                                     // 0x0170 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
// Class GFxUI.GFxAction_InvokeLocalized
// 0x0028 OR 0x0180 (0x0180 - 0x0158)
// 40 OR 384 (384 - 344)
class UGFxAction_InvokeLocalized : public USequenceAction
{
public:
	class UGFxMoviePlayer*                             Movie;                                         // 0x0158 (0x0008) [0x0000000000000000]               
	class FString                                      MethodName;                                    // 0x0160 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class GFxUI.GFxAction_InvokeLocalized");
		}
...
// 0x0048 OR 0x01A0 (0x01A0 - 0x0158)
// 72 OR 416 (416 - 344)
class UGFxAction_OpenMovie : public USequenceAction
{
public:
	class USwfMovie*                                   Movie;                                         // 0x0158 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UClass*                                      MoviePlayerClass;                              // 0x0160 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UGFxMoviePlayer*                             MoviePlayer;                                   // 0x0168 (0x0008) [0x0000000000000000]               
	uint32_t                                           bTakeFocus : 1;                                // 0x0170 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
	uint32_t                                           bCaptureInput : 1;                             // 0x0170 (0x0004) [0x0000000000000001] [0x00000002] (CPF_Edit)
	uint32_t                                           bStartPaused : 1;                              // 0x0170 (0x0004) [0x0000000000000001] [0x00000004] (CPF_Edit)
	uint32_t                                           bEnableGammaCorrection : 1;                    // 0x0170 (0x0004) [0x0000000000000000] [0x00000008] 
	uint32_t                                           bDisplayWithHudOff : 1;                        // 0x0170 (0x0004) [0x0000000000000001] [0x00000010] (CPF_Edit)
	uint32_t                                           bMovieStarted : 1;                             // 0x0170 (0x0004) [0x0000000000000000] [0x00000020] 
	EGFxRenderTextureMode                              RenderTextureMode;                             // 0x0174 (0x0001) [0x0000000000000001] (CPF_Edit)    
	class UTextureRenderTarget2D*                      RenderTexture;                                 // 0x0178 (0x0008) [0x0000000000000001] (CPF_Edit)    
	TArray<struct FName>                               CaptureKeys;                                   // 0x0180 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	TArray<struct FName>                               FocusIgnoreKeys;                               // 0x0190 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
public:
	class UGFxMoviePlayer*                             Movie;                                         // 0x0158 (0x0008) [0x0000000000000000]               
	TArray<struct FName>                               CaptureKeys;                                   // 0x0160 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
public:
	...
	class FString                                      FSCommand;                                     // 0x0180 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
{
public:
	struct FScriptDelegate                             __EventListener__Delegate;                     // 0x00A8 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
