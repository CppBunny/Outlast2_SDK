...
// GObjects
#define GObjects_Offset		(uintptr_t)0x021E2DC8
// GNames
#define GNames_Offset		(uintptr_t)0x021E2D80
...
public:
	...
	uint8_t UnknownData00[0x8]; // 0x000C (0x0008) DYNAMIC FIELD PADDING
	char Name[0x400]; // 0x0014 (0x0001)
